...
- ✅ Получение категорий новостей: 35 категорий получено
...
- ❌ Создание категории: HTTP 500 Internal server error
- ❌ Удаление категории: Нет ID созданной категории

**Итого**: 10/12 тестов пройдено успешно (83% успешности)
