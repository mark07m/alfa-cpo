      ...
      <div className="space-y-6">
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-2">
            ...
            <button
              className="inline-flex items-center px-3 py-2 border text-sm font-medium rounded-lg border-gray-300 text-gray-700 bg-white hover:bg-gray-50 transition-colors"
            >
          ...
          <div className="flex items-center space-x-2">
            <button
              ...
              className={`inline-flex items-center px-3 py-2 border-2 text-sm font-medium rounded-lg transition-colors ${
                showFilters
