...
export async function GET(request: NextRequest) {
  try {
    ...
    const response = await fetch(`${ANALYTICS_URL}/reports${queryString ? `?${queryString}` : ''}`, {
      method: 'GET',
      headers: {
