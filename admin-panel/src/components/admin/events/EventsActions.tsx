      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center space-x-2">
          <button
            ...
            className="inline-flex items-center px-3 py-2 border border-gray-200 shadow-sm text-sm leading-4 font-medium rounded-lg text-gray-700 bg-white hover:border-gray-300 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-primary-100 focus:border-primary-400 disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-150"
          >
            Действия
          </button>
        </div>
